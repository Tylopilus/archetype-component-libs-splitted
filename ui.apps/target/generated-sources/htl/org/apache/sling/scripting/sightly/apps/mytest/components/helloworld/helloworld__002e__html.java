 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.mytest.components.helloworld;
...
out.write("\n    ");
_global_model = renderContext.call("use", com.mytest.core.models.HelloWorldModel.class.getName(), obj());
{
